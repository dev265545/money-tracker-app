...
function AddCategory({ handleclick, id }) {
  ...
  return (
    <div>
      ...
      <div
        ...
        tabindex="-1"
        aria-hidden="true"
        class=" backdrop-blur-3xl h-full flex  fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full"
      >
